        ...
        <b-row class="pb-3">
            ...
            <b-col sm="6" md="6" lg="6" xl="6">
                <div class="text-right">
                    <h5 class="font-w300">Article Categories</h5>
                </div>
            </b-col>
        </b-row>
        <b-row>
            <b-col>
                ...
                >
                    ...
                    <template v-slot:cell(actions)="row" class="d-sm-none d-none"
                        ...
                        <a v-bind:href="'/backend/categories/article/'+ row.item.id +'/update'" class="btn btn-primary"
...
export default {
    ...
    methods: {
        getArticleCategories() {
            axios.get('/axios/categories/article/get-all')
                .then(response => {
